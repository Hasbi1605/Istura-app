...
return [
    'cara-daftar-istura' => [
        ...
        'intro' => 'Ingin mengunjungi Istana Kepresidenan Yogyakarta secara resmi? Program ISTURA (Istana Untuk Rakyat) membuka kesempatan bagi pengunjung, keluarga, sekolah, komunitas, instansi, maupun pendaftar individu/perorangan dengan satu koordinator/penanggung jawab untuk melakukan kunjungan gratis dan melihat langsung kemegahan Gedung Agung. Kunjungan edukasi ini dirancang agar masyarakat dapat mengenal lebih dekat bangunan cagar budaya bersejarah ini. Pendaftaran wajib dilakukan secara online terlebih dahulu dengan mengikuti beberapa langkah mudah berikut ini.',
        ...
        'sections' => [
            [
                ...
                'body' => [
                    ...
                    'Kunjungan melalui program ISTURA ini diselenggarakan sepenuhnya tanpa biaya tiket masuk (100% gratis atau tanpa biaya tiket). Pengunjung juga berkesempatan menjelajahi area museum Istana Kepresidenan Yogyakarta secara langsung di dalam kompleks Gedung Agung sebagai bagian dari kunjungan gratis ke istana. Namun, demi menjaga ketertiban, keamanan, dan kenyamanan lingkungan istana, setiap pengunjung, keluarga, sekolah, komunitas, instansi, maupun pendaftar individu/perorangan dengan satu koordinator/penanggung jawab diwajibkan melakukan pendaftaran terlebih dahulu secara online.',
                ],
                'items' => [],
            ],
            [
                ...
                'body' => [
                    'Pendaftaran kunjungan ISTURA terbuka untuk umum. Program ini dirancang untuk menerima berbagai kalangan pengunjung, keluarga, sekolah, komunitas, instansi, maupun pendaftar individu/perorangan dengan satu koordinator/penanggung jawab.',
                    'Secara eksplisit, siapa pun baik dari jenjang TK, SD, SMP, SMA/SMK, mahasiswa, alumni/sudah lulus kuliah, keluarga, komunitas, hingga masyarakat umum dapat berkunjung ke Istana Kepresidenan Yogyakarta selama mematuhi seluruh ketentuan dan tata tertib yang berlaku. Ketentuan ini berlaku inklusif untuk seluruh lapisan masyarakat yang ingin belajar dan berwisata sejarah secara tertib, termasuk:',
                ],
                'items' => [
                    'Siswa lembaga pendidikan mulai dari jenjang TK, SD, SMP, hingga SMA/SMK.',
                    'Mahasiswa perguruan tinggi aktif serta kelompok ikatan alumni atau yang sudah lulus kuliah.',
                    'Kelompok keluarga, kerabat, atau rombongan lingkungan tempat tinggal.',
                    'Komunitas, organisasi kemasyarakatan, instansi pemerintah/swasta, dan masyarakat umum lainnya.',
                ],
            ],
            [
                ...
                'body' => [
                    ...
                    '2. Isi Formulir Pendaftaran: Masukkan informasi penanggung jawab (contact person), nama kelompok/pendaftar, serta jumlah peserta secara akurat.',
                    '3. Unggah Surat Permohonan: Lampirkan berkas surat permohonan (kop surat dan stempel resmi hanya wajib untuk instansi/sekolah; pendaftar individu/keluarga cukup surat permohonan biasa bertanda tangan koordinator/penanggung jawab).',
            ...
            [
                ...
                'body' => [
                    ...
                    'Siapkan file surat permohonan kunjungan dalam format PDF, JPG, atau PNG dengan ukuran maksimal 5 megabyte. Kop surat resmi dan stempel hanya wajib digunakan untuk sekolah, instansi, atau organisasi resmi. Bagi pendaftar individu, keluarga, atau komunitas non-formal, cukup melampirkan surat permohonan kunjungan biasa yang ditandatangani oleh koordinator/penanggung jawab tanpa wajib menyertakan kop surat maupun stempel. Surat tersebut harus mencantumkan maksud kunjungan, tanggal dan jam kunjungan yang diusulkan, jumlah total peserta, serta tanda tangan penanggung jawab.',
                ],
                'items' => [],
            ],
            [
        ...
        'faqs' => [
            ...
            [
                ...
                'answer' => 'Ya, surat permohonan kunjungan wajib diunggah sebagai kelengkapan dokumen. Namun, kop surat dan stempel resmi hanya diwajibkan untuk instansi resmi, sekolah, atau organisasi formal. Bagi pendaftar individu, keluarga, maupun kelompok non-formal lainnya, cukup melampirkan surat permohonan biasa yang ditandatangani oleh koordinator/penanggung jawab tanpa perlu menyertakan kop surat atau stempel.',
            ],
            [
                'question' => 'Apakah pendaftar individu atau perorangan bisa ikut mendaftar?',
                'answer' => 'Bisa. Pendaftar individu, keluarga, maupun kelompok non-formal lainnya dapat mengajukan pendaftaran secara online. Cukup tunjuk satu orang sebagai koordinator/penanggung jawab untuk mengisi formulir pendaftaran dan melampirkan surat permohonan biasa yang ditandatangani oleh koordinator tersebut (tidak wajib menggunakan kop surat resmi atau stempel).',
            ],
            [
    ...
    'jadwal-kunjungan-istura' => [
        ...
        'sections' => [
            ...
            [
                ...
                'body' => [
                    'Pendaftaran kunjungan reguler secara normal dilakukan paling cepat H+3 (3 hari sebelum tanggal kunjungan) hingga maksimal 2 bulan ke depan.',
                    'Pendaftaran pada hari H, H+1, atau H+2 hanya dimungkinkan jika admin secara khusus membuka slot tersebut selama jam kunjungan belum lewat dan slot masih tersedia.',
                ],
                'items' => [],
            ],
            [
    ...
    'syarat-kunjungan-istura' => [
        ...
        'faqs' => [
            [
                'question' => 'Apakah pengunjung diperbolehkan memakai celana jeans atau kaos oblong?',
                'answer' => 'Tidak diperbolehkan. Pihak Sekretariat Negara secara eksplisit melarang penggunaan celana atau rok berbahan jeans, kaos oblong (T-shirt tanpa kerah), serta sandal demi menjaga etika, kehormatan, dan kesopanan di dalam area Istana Kepresidenan. Seluruh pengunjung diwajibkan mengenakan pakaian berkerah yang rapi, celana panjang kain/rok formal, dan sepatu tertutup.',
            ],
            [
                'question' => 'Bagaimana jika ada anggota rombongan yang terpaksa menggunakan sandal karena cedera?',
                'answer' => 'Penggunaan sandal jenis apa pun dilarang keras di kompleks istana. Jika ada kondisi medis darurat, silakan berkonsultasi dan mengikuti arahan petugas/Posko 1/pemandu di pintu masuk.',
            ],
            [
    ...
    'museum-istana-kepresidenan-yogyakarta' => [
        ...
        'faqs' => [
            [
                ...
                'answer' => 'Tidak. Akses ke museum berada di dalam kawasan tertutup Gedung Agung, sehingga pendaftaran kunjungan (baik individu, keluarga, sekolah, komunitas, maupun instansi) harus diajukan melalui sistem online ISTURA.',
            ],
            [
            ...
            [
                ...
                'answer' => 'Sangat cocok. Museum ini menjadi media pembelajaran sejarah seni rupa Indonesia yang nyata bagi seluruh jenjang pendidikan mulai dari TK, SD, SMP, SMA/SMK, hingga perguruan tinggi dan alumni.',
            ],
            [
                'question' => 'Berapa lama durasi berkunjung di dalam area museum?',
                'answer' => 'Durasi berkunjung di dalam area pameran museum tidak dibatasi secara kaku dalam satuan menit, melainkan mengalir mengikuti alur panduan petugas atau pemandu istana demi menjaga ketertiban sirkulasi pengunjung.',
            ],
        ],
        'links' => [
            [
