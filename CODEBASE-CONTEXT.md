...
- `BookingService.php` — siklus hidup booking, split kloter (`SLOT_CAPACITY = 80`), booking manual admin, pindah langsung, koreksi total eksplisit, dan overbook terkontrol memakai transaksi + `booking_slot_locks`; aksi internal berisiko memakai checkbox konfirmasi dan catatan audit otomatis.
