...
function ContactIcon({ iconKey }: { iconKey: ContactIconKey }) {
  switch (iconKey) {
    case "instagram":
...
function useTypewriter(text: string, speedMs = 22, enabled = true, ready = true) {
