...
export const DEFAULT_BOOKING_WIZARD_CONTENT: BookingWizardContent = {
  ...
  successMessage:
    "Permohonan dengan kode booking {kode} berhasil diterima dengan status menunggu persetujuan. Admin akan menghubungi maksimal 1x24 jam melalui WhatsApp.",
  actions: {
    backLabel: "Kembali",
    nextLabel: "Lanjut",
...
export const DEFAULT_SITE_CONTENT: SiteContent = {
  ...
  cta: {
    ...
    backgroundImage: "/assets/hero-istana-1600.webp",
  },
  footer: {
    logoSrc: ASSETS.logoGold,
