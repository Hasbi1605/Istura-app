...
class BookingResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'feedbackCount' => $this->when($this->shouldExposeFeedbackToken($request), fn () => $this->feedbacks_count ?? $this->feedbacks()->count()),
            'feedbackLimit' => $this->when($this->shouldExposeFeedbackToken($request), fn () => $this->feedbackLimit()),
            'feedbackExpiresAt' => $this->when($this->shouldExposeFeedbackToken($request), fn () => $this->feedback_expires_at?->toIso8601String()),
