        ...
        return [
            ...
            'bookingWizard' => [
                ...
                'schedule' => [
                    ...
                    'largeGroupBody' => 'Rombongan Anda dibagi otomatis menjadi {jumlahKloter} kloter sesuai kapasitas layanan. Jika pembagian waktunya belum sesuai kebutuhan, silakan diskusikan dengan Admin ISTURA. Permintaan penyesuaian akan ditinjau berdasarkan ketersediaan jadwal dan kebutuhan operasional.',
                ...
                'successMessage' => 'Permohonan berhasil dikirim dengan status Pending. Admin akan menghubungi maksimal 1x24 jam melalui WhatsApp.',
                'actions' => [
                    'backLabel' => 'Kembali',
                    'nextLabel' => 'Lanjut',
            ...
            'feedbackWizard' => [
                ...
                'steps' => [
                    ...
                    'visit' => [
                        ...
                        'bubbleEmpty' => 'Nilai pemanduan dan fasilitas, lalu ceritakan bagaimana kamu mengenal ISTURA.',
                        'bubbleDone' => 'Terima kasih. Informasi ini membantu kami memahami pengalaman pengunjung dengan lebih utuh.',
                    ],
                    'details' => [
                ...
                'fields' => [
                    ...
                    'visitedBeforeLegend' => 'Apakah sebelumnya pernah berkunjung ke Gedung Agung?',
                    'visitedBeforeFirstLabel' => 'Belum, ini pertama kali',
                    'visitedBeforeReturnLabel' => 'Ya, pernah',
                    'discoverySourceLabel' => 'Dari mana pertama kali mengetahui program kunjungan ISTURA?',
                ...
                'options' => [
                    ...
                    'improvements' => ['Waktu kunjungan', 'Akses informasi', 'Penjelasan pemandu', 'Fasilitas', 'Dokumentasi', 'Lainnya'],
                ],
                'gates' => [
